...
/**
 * AnuncioOferta filter form base class.
 *
 * @package    guammas
 * @subpackage filter
 ...
 */
abstract class BaseAnuncioOfertaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'comentario'   => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ...
    $this->widgetSchema->setNameFormat('anuncio_oferta_filters[%s]');
