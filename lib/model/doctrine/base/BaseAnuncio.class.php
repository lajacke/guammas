 ...
 * @method date      getDescripcion() Returns the current record's "descripcion" value
 ...
 * @method Anuncio   setImagen()      Sets the current record's "imagen" value
...
abstract class BaseAnuncio extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('descripcion', 'date', 25, array(
             'type' => 'date',
             'fixed' => 0,
             'unsigned' => false,
             'primary' => false,
