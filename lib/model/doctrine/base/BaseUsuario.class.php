 ...
 * @property date $ultimo_inicio_sesion
 ...
 * @method date      getUltimoInicioSesion()   Returns the current record's "ultimo_inicio_sesion" value
...
abstract class BaseUsuario extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('ultimo_inicio_sesion', 'date', 25, array(
             'type' => 'date',
             'fixed' => 0,
             'unsigned' => false,
             'primary' => false,
